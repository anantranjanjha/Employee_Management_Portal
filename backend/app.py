...
def database_conn():
    mydb=mysql.connector.connect(**config) # passing config VAlue as Dictionary
    return mydb


#DATA IS COMING FROM ENVIRONMENT VARIABLE
config = {
    'user': os.environ.get('user'),
    'password': os.environ.get('password'),
    'host': os.environ.get('host'),
    'database': os.environ.get('database'),
    'raise_on_warnings': os.getenv('raise_on_warnings', 'true') == 'true',
